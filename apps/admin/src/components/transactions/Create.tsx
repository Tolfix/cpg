...
import { Create, DateInput, FormDataConsumer, FormTab, NumberInput, ReferenceArrayInput, AutocompleteInput, TabbedForm, TextInput, SelectInput, ReferenceInput } from "react-admin";
